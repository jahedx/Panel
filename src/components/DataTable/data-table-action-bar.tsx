  ...
  return ReactDOM.createPortal(
    visible && (
      <div
        ...
        className={cn(
          "fixed inset-x-0 bottom-6 z-50 mx-auto flex w-fit flex-wrap items-center justify-center gap-2 rounded-md border bg-background p-2 text-foreground shadow-sm transition-all duration-200 ease-in-out",
