      ...
      <div
        className={`pb-2 bg-card text-card-txt-old fixed z-50 ${
          sidebarStatus === "open"
            ...
            : "left-full w-sidebar"
        } top-0 bg-sidebar-bg transition-all h-screen text-sidebar-txt ease-in-out duration-1000 flex flex-col border-l`}
      >
        ...
        <div
          className={`mx-auto transition-all w-full py-4 ${isCollapsed ? "px-2" : "px-4"}`}
        >
